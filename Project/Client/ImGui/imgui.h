...
namespace ImGui
{
    ...
    IMGUI_API float         GetTextWidth();                                                  // get current font size (= height in pixels) of current font with current scale applied
...
namespace ImGui
{
    ...
    //static inline float GetWindowFontSize()                   { return GetTextWidth(); }                                           // OBSOLETED in 1.48
